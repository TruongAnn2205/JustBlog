        ...
        public static void SeedData(this ModelBuilder builder)
        {
            ...
            var users = new User[]
            {
                new User
                {
                    ...
                    NormalizedUserName = "truongan123".ToUpper(),
                    Email = "truongan123@gmail.com",
                    NormalizedEmail = "truongan123@gmail.com".ToUpper(),
                    EmailConfirmed = true,
                    AccessFailedCount = 0,
                    PasswordHash = new PasswordHasher<User>().HashPassword(null!, "Truongan123")
},
                new User
                {
                    Id = Guid.NewGuid().ToString(),
                    ...
                    NormalizedUserName = "truongan1234".ToUpper(),
                    Email = "truongan1234@gmail.com",
                    NormalizedEmail = "truongan1234@gmail.com".ToUpper(),
                    EmailConfirmed = true,
                    AccessFailedCount = 0,
                    PasswordHash = new PasswordHasher<User>().HashPassword(null!, "Truongan1234")
                },
                new User
                {
                    Id = Guid.NewGuid().ToString(),
                    ...
                    NormalizedUserName = "truongan12345".ToUpper(),
                    Email = "truongan12345@gmail.com",
                    NormalizedEmail = "truongan12345@gmail.com".ToUpper(),
                    EmailConfirmed = true,
                    AccessFailedCount = 0,
                    PasswordHash = new PasswordHasher<User>().HashPassword(null!, "Truongan12345")
                },
            };
